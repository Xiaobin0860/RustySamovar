...
#[packet_processor(GetSceneAreaReq, GetScenePointReq)]
...
impl SceneSubsystem {
    ...
    fn process_get_scene_area(
        &self,
        user_id: u32,
        metadata: &proto::PacketHead,
        req: &proto::GetSceneAreaReq,
        rsp: &mut proto::GetSceneAreaRsp,
    ) {
    ...
    fn process_get_scene_point(
        &self,
        user_id: u32,
        metadata: &proto::PacketHead,
        req: &proto::GetScenePointReq,
        rsp: &mut proto::GetScenePointRsp,
    ) {
